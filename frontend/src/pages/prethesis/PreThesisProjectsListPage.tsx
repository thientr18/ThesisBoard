...
import AllTeacherPreTheses from '../../components/pre-thesis/project/AllTeacherPreTheses';
import AllAdministratorPreTheses from '../../components/pre-thesis/project/AllAdministratorPreTheses';
...
const PreThesisProjectsListPage: React.FC = () => {
  ...
  return (
    <>
      ...
      >
        <Navbar user={user} pageName="Pre-Thesis Projects" />
              ...
              <>
                {user && Array.isArray(user.roles) ? (
                  user.roles.some((r: any) => r.name === 'admin' || r.name === 'moderator') ? (
                    <AllAdministratorPreTheses user={user} semester={selectedSemester} />
                  ) : user.roles.some((r: any) => r.name === 'teacher') ? (
                    <AllTeacherPreTheses user={user} semester={selectedSemester} />
                  ) : (
                    <Alert
