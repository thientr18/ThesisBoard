...
import { PreThesisService } from '../services/PreThesisService';
  ...
  getApplications = async (req: Request, res: Response, next: NextFunction): Promise<void> => {
    try {
      ...
      if (studentId) {
        ...
        throw new AppError('Please provide studentId or topicId', 400);
      }
  ...
  getPreTheses = async (req: Request, res: Response, next: NextFunction): Promise<void> => {
    try {
      ...
      if (studentId) {
        ...
        throw new AppError('Please provide valid query parameters', 400);
      }
  ...
  gradePreThesis = async (req: Request, res: Response, next: NextFunction): Promise<void> => {
    try {
      ...
      if (finalScore === undefined || finalScore === null) {
        throw new AppError('Final score is required', 400);
      }
